...
Автоматическое управление ценами для продавцов на **Ozon**, **Wildberries** и **Яндекс.Маркете**.

Держит цену на заданном эталоне, не даёт продавать ниже безубыточности, рассчитанной по реальным тарифам каждой площадки, выводит товары из акций, которые уводят их под себестоимость, и — при желании — сам ищет лучшую цену, ставя управляемый эксперимент на живых продажах.
